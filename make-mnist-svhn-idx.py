'''
This python file generates indicies to create the MNIST/SVHN dataset needed for testing the multimodal mmae. 
This file comes from the following repo: https://github.com/iffsid/mmvae and is located at mmvae/bin/make-mnist-svhn-idx.py
'''
...
if __name__ == '__main__':
    ...
    torch.save(idx1, '/home/rachel/Desktop/mm-vae/data/train-ms-mnist-idx.pt')
    torch.save(idx2, '/home/rachel/Desktop/mm-vae/data/train-ms-svhn-idx.pt')
    ...
    # using absolute path 
    torch.save(idx1, '/home/rachel/Desktop/mm-vae/data/test-ms-mnist-idx.pt')
    torch.save(idx2, '/home/rachel/Desktop/mm-vae/data/test-ms-svhn-idx.pt')