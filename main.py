...
if __name__ == "__main__":
    ...
    for epoch in range(1, epochs + 1):
        ...
        train_loss, recon_loss, kld_loss = train(epoch, model, train_loader, device, optimizer, log_interval, loss_type)
        test_loss, recon_test_loss, kld_test_loss = test(epoch, model, test_loader, device, batch_size, output_folder, loss_type)
        total_train_loss.append(train_loss)
        total_recon_loss.append(recon_loss)
        total_kld_loss.append(kld_loss)
        total_test_loss.append(test_loss)
        total_recon_test_loss.append(recon_test_loss)
    ...
    ax[0].plot(total_recon_loss, color='red', label='Training Reconstruction loss')
    ...
    ax[1].plot(total_recon_test_loss, color='red', label='Testing Reconstruction loss')
    ...
    ax[0].plot(np.log(total_recon_loss), color='red', label='Training Reconstruction loss')
    ...
    ax[1].plot(np.log(total_recon_test_loss), color='red', label='Testing Reconstruction loss')
