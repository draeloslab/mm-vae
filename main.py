...
beam_break_data = pd.read_csv('/home/rachel/Desktop/mm-vae_ext2/data/raw_beam_break_standardized_binned.csv')
...
if __name__ == "__main__":
    ...
    for epoch in range(1, epochs + 1):
        train_loss, bce_loss, kld_loss = train(epoch, model, train_loader, device, optimizer, log_interval, test_loader, latent_dim, output_folder)
